 ...
 *
 * Declared as a constant so {@see \Phlix\Plugins\Metadata\Omdb\Tests\SecurityAuditCheckTest} can assert the list directly
 ...
 *
 * Measured on this repository's committed lock 2026-08-06: 37 packages
 * (5 require + 32 require-dev). The floor sits below that so ordinary
 ...
 * on this repository's committed lock: 32 dev packages.
 */
const MIN_AUDITED_DEV_PACKAGES = 27;
